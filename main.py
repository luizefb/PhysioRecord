...
def main(page: ft.Page, route="/relatorio_1"):
            ...
            page.views.append(
                ft.View(
                    ...
                    controls=[
                        ...
                        ft.Container(btn_clear, alignment=ft.alignment.center)
                    ],
                )
            )
        page.update()
    ...
    texto_index_index = ft.Text(
        "Index_Index",
        size=20,
        weight=ft.FontWeight.BOLD,
    )
    texto_index_nariz = ft.Text(
        "Index_Nariz",
        size=20,
        weight=ft.FontWeight.BOLD,
    )
    ...
    avd_teste = ft.TextField(value=avd)
    avd_teste2 = ft.Checkbox(value=avd.value)
    avd_valor = str(avd)
    avd_valor2 = str(avd_valor)
    ...
    def pesquisa(link:str):
        ...
        #MoSTRA NA TELA AS INFO DO PACIENTE
        #lv.controls.append(ft.Text(f"Nome: {paciente_info["nome"]}"))
        lv.controls.append(ft.Text("Nome: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["nome"]))
        lv.controls.append(ft.Text("Idade: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["idade"]))
        lv.controls.append(ft.Text("Telefone: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["telefone"]))
        lv.controls.append(ft.Text("Endereço: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["cidade"]))
        lv.controls.append(ft.Text("Anamnese: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["anamnese"]))
        lv.controls.append(ft.Text("Inspeção: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["inspecao"]))
        lv.controls.append(ft.Text("Palpação: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["palpacao"]))
        lv.controls.append(ft.Text("ADM: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["adm"]))
        lv.controls.append(ft.Text("Reflexos: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["reflexos"]))
        lv.controls.append(ft.Text("Motricidade Involuntária: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["motricidade Involuntaria"]))
        lv.controls.append(ft.Text("Atividades Funcionais: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["atividades Funcionais"]))
        lv.controls.append(ft.Text("Observações: ", theme_style=ft.TextThemeStyle.TITLE_MEDIUM))
        lv.controls.append(ft.Text(paciente_info["Observacoes"]))
        page.update()

    #botão pesquisa
    pesquisa_prof_button = ft.IconButton(icon=ft.icons.SEARCH,icon_color="blue400",icon_size=30,tooltip="Buscar", on_click=lambda e: pesquisa(link))
    btn_clear = ft.ElevatedButton(content=ft.Text("Limpar", color="BLACK"), bgcolor="WHITE",on_click=lambda e: clear())
    ...
    btn_enviar = ft.ElevatedButton(
        ...
        adaptive=True,
        bgcolor="WHITE",
        on_click=lambda e: insert(link, e),
        style=ft.ButtonStyle(
            padding=30,
            shape=ft.RoundedRectangleBorder(radius=5),
        ),
